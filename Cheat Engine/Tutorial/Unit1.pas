...
resourcestring
  rsFirstStepTooHardBetterGiveUpNow =
    'First step too hard? Go to forum.localhost, then click on "Tutorials" for helpful guides!';

  rsTutorial1='Welcome to the DataViewer Tutorial (v3.6)'+#13#10+
              ''+#13#10+
              'This tutorial will teach you the basics of cheating in video games. It will also show you foundational aspects of using DataViewer (or CE for short). Follow the steps below to get started.'+#13#10+
              ''+#13#10+
              '1: Open DataViewer if it currently isn''t running.'+#13#10+
              ...
              ''+#13#10+
              'Congratulations! If you did everything correctly, the process window should be gone with DataViewer now attached to the tutorial (you will see the process name towards the top-center of CE).'+#13#10+
              ''+#13#10+
              'Click the "Next" button below to continue, or fill in the password and click the "OK" button to proceed to that step.)'+#13#10+
              ''+#13#10+
              'If you''re having problems, simply head over to forum.localhost, then click on "Tutorials" to view beginner-friendly guides!';
