...
begin
  ...
  begin
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:='This will attach the debugger of Memory Toolkit to the current process. If you close Memory Toolkit while the game is running, the game will close too. Are you sure you want to do this?'
    else
      mes:='This will attach the debugger of Memory Toolkit to the current process. Continue?';
...
//        attaching:=false;
        ...
        err:='Memory Toolkit failed to create the process. (Error='+pchar(IntToStr(GetLastError))+')';
        messagebox(0,pchar(err),'Create failure',mb_ok);
  ...
  //    }
      ...
      begin
        ...
        {$ifndef net}
        err:='Memory Toolkit failed to attach to the process. (Error='+IntToStr(GetLastError)+')';
                      ...
                      try
                        ...
                        begin
                          ...
                          begin
                            ...
                            j:=devent.dwThreadId;
                            if not WaitForDebugEvent(devent,10000) then application.MessageBox('userbreakpoint bug','Memory Toolkit Debugger',0);
