...
{^^^^^^^^^^^^^^^^^}
  ...
  {  for i:=32 to 63 do
    ...
    begin
      ...
      MessageBox(0,pchar('disassembler exception at '+inttohex(startoffset,8)+#13#10+'Debugpart='+inttostr(debugpart)+#13#10+e.message+#13#10+#13#10+'Please provide the developer the bytes that are at this address so they can fix it'#13#10'(Open another instance and in the hexadecimal view go to this address)'),'debug here',MB_OK);
    end;
  end;
end;
