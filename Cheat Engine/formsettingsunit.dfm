object formSettings: TformSettings
  ...
  Caption = 'Memory Toolkit settings'
  Color = clBtnFace
    ...
    object pcSetting: TPageControl
      ...
      object GeneralSettings: TTabSheet
        ...
        object cbCenterOnPopup: TCheckBox
          ...
          Width = 601
          Height = 21
          Caption = 'Center Memory Toolkit when bringing to front'
          Checked = True
          State = cbChecked
          TabOrder = 2
        end
        object EditUpdateInterval: TEdit
          ...
          Height = 24
          Hint = 
            'The number of milliseconds that Memory Toolkit will wait before re' +
        ...
        object cbHideAllWindows: TCheckBox
          ...
          Height = 21
          Caption = 
            'Hide some/all windows instead of trying to bring memory toolkit to' +
            ' front'
          Checked = True
          State = cbChecked
          TabOrder = 9
      ...
      object CodeFinder: TTabSheet
        ...
        object Label4: TLabel
          ...
          Align = alTop
          Caption = 
            'There are 2 ways Memory Toolkit can find the addresss of code that' +
  ...
  object OpenDialog1: TOpenDialog
    DefaultExt = 'DLL'
    Filter = 'Memory Toolkit Plugins (*.dll)|*.dll'
    Left = 52
    Top = 264
  end
