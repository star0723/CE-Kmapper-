...
begin
  ...
  r:=DotNetExecuteClassMethod({$ifdef standalonetest}'D:\git\cheat-engine\DataViewer\bin\CSCompiler.dll'{$else}CheatEngineDir+'CSCompiler.dll'{$endif},'CSCompiler','Compiler','NewCompiler',inttostr(ptruint(@delegates)));
